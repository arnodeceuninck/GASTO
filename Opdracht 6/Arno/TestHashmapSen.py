...
if(test_hashmap.tableRetrieve("test2")[0] == False and test_hashmap.tableRetrieve("test1")[1] == "Dit is de tekst die hoort bij de zoeksleutel test1"){
...
if(test_hashmap.tableRetrieve("test3")[0] == False and test_hashmap.tableRetrieve("test1")[1] == "Dit is de tekst die hoort bij de zoeksleutel test1" and test_hashmap.tableRetrieve("test2")[1] == "Dit is de tekst die hoort bij de zoeksleutel test2"){
